...
public class SpotStadiumController {
    ...
    @GetMapping("/{stadium}/{category}/{pagesize}/{pageindex}/{radius}")
    ...
    public ResponseEntity<SpotStadiumPreviewResponse> getStadiumSpot(@PathVariable String stadium, @PathVariable String category,
        ...
        SpotStadiumPreviewResponse spotStadiumPreviewResponse = spotService.getStadiumSpot(stadium, category, pagesize, pageindex, radius,userPrincipal);
