...
public class EmailScheduler {
    ...
    private String makeMessage(BaseballScrap baseballScrap, String restDay){
        ...
        return "안녕하세요, " + userName + "님!\n" +
                ...
                "\n" +
                "경기 정보:\n" +
                "- **경기 일시**: "+baseballScrap.getBaseball().getTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"))+ " (" +
                baseballScrap.getBaseball().getWeekDay() + ") " +
                baseballScrap.getBaseball().getTime().format(DateTimeFormatter.ofPattern("HH:mm"))+"\n" +
